		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Car Shop",
									"targetURL": "#mhpdemocarshop-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mhpdemocarshop-display": {
								"semanticObject": "mhpdemocarshop",
								"action": "display",
								"description": "This is a nice car shop",
								"title": "Car Shop",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mhp.demo.carshop",
									"url": sap.ui.require.toUrl("mhp/demo/carshop")
								}
							}
						}
					}
